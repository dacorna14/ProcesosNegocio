...
public class UserController {
    ...
    public ResponseEntity createUser(@RequestBody User user){
        ...
        try{
            ...
            return message.viewMessage(HttpStatus.INTERNAL_SERVER_ERROR, "error", "An error ocurred while registering the user");
        }
    }

    @RequestMapping(value = "api/users", method = RequestMethod.GET)
    public List<User> listUser(@RequestHeader(value = "Authorization") String token){
        if(validarToken(token) == false){ return null;}
